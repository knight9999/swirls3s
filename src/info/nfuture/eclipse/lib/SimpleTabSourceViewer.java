...
public class SimpleTabSourceViewer extends SourceViewer {
	protected SimpleTabSetting tabSetting;
	protected int nextChar = -1;
	
	public SimpleTabSourceViewer(Composite parent, IVerticalRuler ruler,
			int styles,SimpleTabSetting ts) {
	...
	public SimpleTabSourceViewer(Composite parent,
			IVerticalRuler verticalRuler, IOverviewRuler overviewRuler,
			boolean showAnnotationsOverview, int styles,SimpleTabSetting ts) {
...
//					System.out.println(e.toString());
	...
	public SimpleTabSetting getTabSetting() {
		return tabSetting;
	}

	public void setTabSetting(SimpleTabSetting tabSetting) {
